...
#define X264_CSP_T420           0x0003  /* tile 4:2:0 planar */
#define X264_CSP_NV21           0x0004  /* yuv 4:2:0, with one y plane and one packed v+u */
#define X264_CSP_NV12           0x0005  /* yuv 4:2:0, with one y plane and one packed u+v */
...
#define X264_CSP_V210           0x0009  /* 10-bit yuv 4:2:2 packed in 32 */
#define X264_CSP_I444           0x000a  /* yuv 4:4:4 planar */
#define X264_CSP_YV24           0x000b  /* yvu 4:4:4 planar */
#define X264_CSP_BGR            0x000c  /* packed bgr 24bits   */
#define X264_CSP_BGRA           0x000d  /* packed bgr 32bits   */
#define X264_CSP_RGB            0x000e  /* packed rgb 24bits   */
#define X264_CSP_MAX            0x000f  /* end of list */
...
typedef struct
{
    ...
    unsigned int roi_md;
    unsigned int roi_qp;
    unsigned int roi_lmbx;
    unsigned int roi_rmbx;
    unsigned int roi_umby;
    unsigned int roi_bmby;
} x264_roi_t;
...
//#endif //CONFIG_JZ_HARDWARE
    ...
    char        *psz_dump_bs;  /* filename (in UTF-8) for raw bitstream frames */
