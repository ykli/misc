 ...
 * UNKNOWN等級打印接口
 */
#define IMP_LOG_UNK(tag, fmt, ...)		IMP_LOG_TO_SERVER(tag, IMP_LOG_LEVEL_UNKNOWN, IMP_LOG_GET_OPTION, fmt, ##__VA_ARGS__)
/**
 * @def IMP_LOG_VERBOSE
 * VERBOSE等級打印接口
 */
#define IMP_LOG_VERBOSE(tag, fmt, ...)		IMP_LOG_TO_SERVER(tag, IMP_LOG_LEVEL_VERBOSE, IMP_LOG_GET_OPTION, fmt, ##__VA_ARGS__)
/**
 * @def IMP_LOG_DBG
 * DEBUG等級打印接口
 */
#define IMP_LOG_DBG(tag, fmt, ...)		IMP_LOG_TO_SERVER(tag, IMP_LOG_LEVEL_DEBUG, IMP_LOG_GET_OPTION, fmt, ##__VA_ARGS__)
/**
 * @def IMP_LOG_INFO
 * INFO等級打印接口
 */
#define IMP_LOG_INFO(tag, fmt, ...)		IMP_LOG_TO_SERVER(tag, IMP_LOG_LEVEL_INFO, IMP_LOG_GET_OPTION, fmt, ##__VA_ARGS__)
/**
 * @def IMP_LOG_WAR
 * WARN等級打印接口
 */
#define IMP_LOG_WARN(tag, fmt, ...)		IMP_LOG_TO_SERVER(tag, IMP_LOG_LEVEL_WARN, IMP_LOG_GET_OPTION, fmt, ##__VA_ARGS__)
/**
 * @def IMP_LOG_ERR
 * ERROR等級打印接口
 */
#define IMP_LOG_ERR(tag, fmt, ...)		IMP_LOG_TO_SERVER(tag, IMP_LOG_LEVEL_ERROR, IMP_LOG_GET_OPTION, fmt, ##__VA_ARGS__)
/**
 * @def IMP_LOG_FATAL
 * FATAL等級打印接口
 */
#define IMP_LOG_FATAL(tag, fmt, ...)		IMP_LOG_TO_SERVER(tag, IMP_LOG_LEVEL_FATAL, IMP_LOG_GET_OPTION, fmt, ##__VA_ARGS__)
/**
 * @def IMP_LOG_SILENT
 * SILENT等級打印接口
 */
#define IMP_LOG_SILENT(tag, fmt, ...)		IMP_LOG_TO_SERVER(tag, IMP_LOG_LEVEL_SILENT, IMP_LOG_GET_OPTION, fmt, ##__VA_ARGS__)
