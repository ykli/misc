...
//      16      RD_             -		-		-		
//      17      WE_             -		-		-		
//      18      FRE_            MSC0_D0		SSI0_CLK	-		
//      19      FWE_		MSC0_CMD	SSI0_DT		-		
//      20      -		MSC0_CLK	SSI0_DR		-		1
//      21      CS1_            MSC0_D1         -		-		
//      22      CS2_            MSC0_D2		-		-		
//      23      CS3_		MSC0_D3		SSI0_CE0	-		
//      24      CS4_ 		MSC0_RST_	-		-		
//      25      CS5_		-		-		-		
//      26      CS6_		RDWR_		-		-		
//      27      WAIT_		-		-		-		
...
//	8	CIM1_VSYN_i(i)	-		-		-		
//	9	CIM1_MCLK_o(o)	-		-		-		
//	10	CIM1_D0_i(i) 	SD8_o(o)	-		-		
//	11	CIM1_D1_i(i) 	SD9_o(o)	-		-		
//	12	CIM1_D2_i(i) 	SD10_o(o)	-		-		
//	13	CIM1_D3_i(i) 	SD11_o(o)	-		-		
//	14	CIM1_D4_i(i) 	SD12_o(o)	-		-		
//	15	CIM1_D5_i(i) 	SD13_o(o)	-		-		
//	16	CIM1_D6_i(i) 	SD14_o(o)	-		-		
//	17	CIM1_D7_i(i) 	SD15_o(o)	-		-		
//	18	-		-		-		-		
//	19	-		-		-		-		
//	20	-		-		-		-		
//	21	-		-		-		-		
...
#define GPIO_BASEG GPIO_BASE +(6)*0x100
...
#define MAX_GPIO_NUM	224
#define GPIO_WAKEUP     (30)  //WAKE_UP key PA30

//n = 0,1,2,3,4,5,6 (PORTA, PORTB, PORTC, PORTD, PORTE, PORTF, PORTG)
...
#define __gpio_as_msc1 	__gpio_e_as_msc1_4bit /* msc1 only support 4bit */
...
//fixme twxie
#if 1
#define __gpio_d_as_ssi0()				\
	do {						\
		REG_GPIO_PXINTC(3) = 0x01B00000;	\
		REG_GPIO_PXMASKC(3) = 0x01B00000;	\
		REG_GPIO_PXPAT1C(3) = 0x01B00000;	\
		REG_GPIO_PXPAT0S(3) = 0x01B00000;	\
	} while (0)
#else
#define __gpio_d_as_ssi0()  
#endif
#define __gpio_as_ssi() __gpio_d_as_ssi0()
...
#define __gpio_as_spi_boot()				\
	do {						\
		REG_GPIO_PXINTC(0) = 0x009C0000;	\
		REG_GPIO_PXMASKC(0) = 0x009C0000;	\
		REG_GPIO_PXPAT1S(0) = 0x009C0000;	\
		REG_GPIO_PXPAT0C(0) = 0x009C0000;	\
	} while (0)
