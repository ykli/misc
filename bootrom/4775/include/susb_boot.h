...
static u8 device_desc[] = {	0x12, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x40,
				//0x08, 0xa1, 0x80, 0x47, /* 0xa108 0x4780 */ 
				0x08, 0xa1, 0x75, 0x47, /* 0xa108 0x4775 */
				0x00, 0x01, 0x01, 0x02, 0x00, 0x01};

static u8 dev_qualifier[] = {	0x0a, 0x06, 0x00, 0x02, 0x00, 0x00, 0x00, 0x40, 
				0x01, 0x00};

static u8 hs_desc[] = {	0x09, 0x02, 0x20, 0x00, 0x01, 0x01, 0x00, 0xc0, 0x01, 
			0x09, 0x04, 0x00, 0x00, 0x02, 0xff, 0x00, 0x50, 0x00, 
			0x07, 0x05, 0x01, 0x02, 0x00, 0x02, 0x00, 
			0x07, 0x05, 0x81, 0x02, 0x00, 0x02, 0x00};

static u8 fs_desc[] = {	0x09, 0x02, 0x20, 0x00, 0x01, 0x01, 0x00, 0xc0, 0x01, 
			0x09, 0x04, 0x00, 0x00, 0x02, 0xff, 0x00, 0x50, 0x00, 
			0x07, 0x05, 0x01, 0x02, 0x40, 0x00, 0x00, 
			0x07, 0x05, 0x81, 0x02, 0x40, 0x00, 0x00};

static u8 string_lang_ids[] = {0x04, 0x03, 0x09, 0x04};	// English

static u8 string_manufacture[] = {	0x10, 0x03, 0x49, 0x00, 0x6e, 0x00, 0x67, 0x00, 
					0x65, 0x00, 0x6e, 0x00, 0x69, 0x00, 0x63, 0x00	};

static u8 string_product[] = {	0x2e, 0x03, 
				0x4a, 0x00, // J
				0x5a, 0x00, // Z
				0x34, 0x00, // 4
				0x37, 0x00, // 7
				0x37, 0x00, // 7	//0x38, 0x00, // 8	
				0x35, 0x00, // 5	//0x30, 0x00, // 0	//0x35, 0x00, // 5
				0x20, 0x00, // 
				0x55, 0x00, // U
				0x53, 0x00, // S
				0x42, 0x00, // B
...
static u8 cpu_info_data[] = {	0x4a, // J
				0x5a, // Z
				0x34, // 4
				0x37, // 7
				0x37, // 7	//0x38, // 8
