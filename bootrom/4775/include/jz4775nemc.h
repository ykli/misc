...
#define NEMC_TGHL	(NEMC_BASE + 0x150) /* Toggle NAND DQS Hold Time for Data Input Finish (bank 1/2/3 TGHL) */
#define NEMC_TGHH	(NEMC_BASE + 0x154) /* Toggle NAND DQS Hold Time for Data Input Finish (bank 4/5/6 TGHH) */
...
#define REG_NEMC_TGHL	REG32(NEMC_TGHL)
#define REG_NEMC_TGHH	REG32(NEMC_TGHH)

/* Static Memory Control Register (SMCR1~6) */
#define NEMC_SMCR_STRV_BIT	24
#define NEMC_SMCR_STRV_MASK	(0x3F << NEMC_SMCR_STRV_BIT)
#define NEMC_SMCR_TAW_BIT	20
#define NEMC_SMCR_TAW_MASK	(0xF << NEMC_SMCR_TAW_BIT)
#define NEMC_SMCR_TBP_BIT	16
#define NEMC_SMCR_TBP_MASK	(0xF << NEMC_SMCR_TBP_BIT)
#define NEMC_SMCR_TAH_BIT	12
#define NEMC_SMCR_TAH_MASK	(0xF << NEMC_SMCR_TAH_BIT)
#define NEMC_SMCR_TAS_BIT	8
#define NEMC_SMCR_TAS_MASK	(0xF << NEMC_SMCR_TAS_BIT)
#define NEMC_SMCR_BW_BIT	6
#define NEMC_SMCR_BW_MASK	(0x3 << NEMC_SMCR_BW_BIT)
#define NEMC_SMCR_BW_8		(0x0 << NEMC_SMCR_BW_BIT)
#define NEMC_SMCR_BW_16		(0x1 << NEMC_SMCR_BW_BIT)
...
/* Toggle NAND Control Register (TGCR1 ~ 6) */
#define NEMC_TGCR_TRV_BIT	24
#define NEMC_TGCR_TRV_MASK	(0x3F << NEMC_TGCR_TRV_BIT)
#define NEMC_TGCR_TRW_BIT	20
#define NEMC_TGCR_TRW_MASK	(0xF << NEMC_TGCR_TRW_BIT)
#define NEMC_TGCR_TWW_BIT	16
#define NEMC_TGCR_TWW_MASK	(0xF << NEMC_TGCR_TWW_BIT)
#define NEMC_TGCR_TAH_BIT	12
#define NEMC_TGCR_TAH_MASK	(0xF << NEMC_TGCR_TAH_BIT)
#define NEMC_TGCR_TAS_BIT	8
#define NEMC_TGCR_TAS_MASK	(0xF << NEMC_TGCR_TAS_BIT)
#define NEMC_TGCR_DPHT_BIT	0
#define NEMC_TGCR_DPHT_MASK	(0xF << NEMC_TGCR_DPHT_BIT)
