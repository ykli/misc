...
#define JZ_RTC_CLK  32768     /* 32.768 KHz */
...
#define CPCCR_L2CDIV_LSB	4
#define CPCCR_L2CDIV_MASK	BITS_H2L(11, CPCCR_L2CDIV_LSB)

/* APLL control register */
#define CPAPCR_APLLM_LSB	19
#define CPAPCR_APLLM_MASK	BITS_H2L(31, CPAPCR_APLLM_LSB)

#define CPAPCR_APLLN_LSB	13
#define CPAPCR_APLLN_MASK	BITS_H2L(18, CPAPCR_APLLN_LSB)

#define CPAPCR_APLLOD_LSB	9
#define CPAPCR_APLLOD_MASK	BITS_H2L(12, CPAPCR_APLLOD_LSB)

#define CPAPCR_APLL_ON		BIT4

/* MPLL control register */
#define CPMPCR_MPLLM_LSB	19
#define CPMPCR_MPLLM_MASK	BITS_H2L(31, CPMPCR_MPLLM_LSB)

#define CPMPCR_MPLLN_LSB	13
#define CPMPCR_MPLLN_MASK	BITS_H2L(18, CPMPCR_MPLLN_LSB)

#define CPMPCR_MPLLOD_LSB	9
#define CPMPCR_MPLLOD_MASK	BITS_H2L(12, CPMPCR_MPLLOD_LSB)

#define CPMPCR_MPLL_ON		BIT4
/* new end */
...
#define CPM_CPCSR_OFFSET	(0xd4)
#define CPM_SBCR_OFFSET		(0xc8)  /* rw, 32, sleep boot control register */
#define CPM_SP_OFFSET		(0xcc)  /* rw, 32, sleep pc register */
...
#define CPM_SBCR	(CPM_BASE + CPM_SBCR_OFFSET)
#define CPM_SP		(CPM_BASE + CPM_SP_OFFSET)
...
#define MSCCDR_STOP		BIT27
#define MSCCDR_CLK_SEL		BIT15
...
#define REG_CPM_SBCR		REG32(CPM_SBCR)
#define REG_CPM_SP		REG32(CPM_SP)
...
unsigned int cpm_set_clock(cgu_clock name, unsigned int clock);
