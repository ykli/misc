/*
 *
 * JZ4785 GPIO register definition.
 *
 * Copyright (C) 2012 Ingenic Semiconductor Co., Ltd.
 */

#ifndef __JZ4785GPIO_H__
#define __JZ4785GPIO_H__
...
do {						\
	...
	/* FRB#(device3) */			\
	REG_GPIO_PXINTC(0)  = 0x00900000; \
	REG_GPIO_PXMASKC(0)  = 0x00900000; \
	REG_GPIO_PXPAT1S(0) = 0x00900000;  \
	REG_GPIO_PXPAT0S(0) = 0x00900000;  \
} while (0)
...
do {						\
	REG_GPIO_PXINTC(0)  = 0x001c0000;	\
	REG_GPIO_PXMASKC(0) = 0x001c0000;	\
	REG_GPIO_PXPAT1C(0) = 0x001c0000;	\
	REG_GPIO_PXPAT0S(0) = 0x001c0000;	\
} while (0)
