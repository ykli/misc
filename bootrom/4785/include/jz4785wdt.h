/*
 *
 * JZ4785 wdt register definition.
 *
 * Copyright (C) 2010 Ingenic Semiconductor Co., Ltd.
 */

#ifndef __JZ4785WDT_H__
#define __JZ4785WDT_H__
 ...
 *************************************************************************/
#define WDT_TDR		(WDT_BASE + 0x0)
#define WDT_TCER	(WDT_BASE + 0x4)
#define WDT_TCNT	(WDT_BASE + 0x8)
#define WDT_TCSR	(WDT_BASE + 0xc)

#define REG_WDT_TDR	REG32(WDT_TDR)
#define REG_WDT_TCER	REG32(WDT_TCER)
#define REG_WDT_TCNT	REG32(WDT_TCNT)
#define REG_WDT_TCSR	REG32(WDT_TCSR)
