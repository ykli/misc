/*
 *
 * JZ4785 INTC register definition.
 *
 * Copyright (C) 2010 Ingenic Semiconductor Co., Ltd.
 */

#ifndef __JZ4785INTC_H__
#define __JZ4785INTC_H__
...
#define NUM_GPIO        MAX_GPIO_NUM	/* GPIO NUM: 192, Jz4785 real num GPIO 178 */
