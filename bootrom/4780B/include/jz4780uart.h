/*
 * linux/include/asm-mips/mach-jz4780/jz4780uart.h
 *
 * JZ4780 UART register definition.
 *
 * Copyright (C) 2010 Ingenic Semiconductor Co., Ltd.
 */

#ifndef __JZ4780UART_H__
#define __JZ4780UART_H__
...
#define UART4_RDR	(UART4_BASE + OFF_RDR)
#define UART4_TDR	(UART4_BASE + OFF_TDR)
#define UART4_DLLR	(UART4_BASE + OFF_DLLR)
#define UART4_DLHR	(UART4_BASE + OFF_DLHR)
#define UART4_IER	(UART4_BASE + OFF_IER)
#define UART4_ISR	(UART4_BASE + OFF_ISR)
#define UART4_FCR	(UART4_BASE + OFF_FCR)
#define UART4_LCR	(UART4_BASE + OFF_LCR)
#define UART4_MCR	(UART4_BASE + OFF_MCR)
#define UART4_LSR	(UART4_BASE + OFF_LSR)
#define UART4_MSR	(UART4_BASE + OFF_MSR)
#define UART4_SPR	(UART4_BASE + OFF_SPR)
#define UART4_SIRCR	(UART4_BASE + OFF_SIRCR)
#define UART4_UMR	(UART4_BASE + OFF_UMR)
#define UART4_UACR	(UART4_BASE + OFF_UACR)
#define UART4_URCR	(UART4_BASE + OFF_URCR)
#define UART4_UTCR	(UART4_BASE + OFF_UTCR)
