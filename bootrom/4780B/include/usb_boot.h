...
typedef struct usb_status {
	...
	u32 xfer_size;
	//enum trans_status;		//ep0 status
#ifdef HAVE_IN_ZERO_PACKET
	u8 need_zpkt;			//use zero packet
#endif
	enum trans_status trans_status;
} USB_STATUS;

/*---------------------------------------------------------*/
/*---------------------------------------------------------*/
static const u8 device_desc[] = {	0x12, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x40,
				0x08, 0xa1, 0x80, 0x47, 0x00, 0x01, 0x01, 0x02,
				0x00, 0x01					};

static const u8 dev_qualifier[] = {	0x0a, 0x06, 0x00, 0x02, 0x00, 0x00, 0x00, 0x40,
				0x01, 0x00					};

static const u8 hs_desc[] = {	0x09, 0x02, 0x20, 0x00, 0x01, 0x01, 0x00, 0xc0,
			0x01, 0x09, 0x04, 0x00, 0x00, 0x02, 0xff, 0x00,
			0x50, 0x00, 0x07, 0x05, 0x01, 0x02, 0x00, 0x02,
			0x00, 0x07, 0x05, 0x81, 0x02, 0x00, 0x02, 0x00	};

static const u8 fs_desc[] = {	0x09, 0x02, 0x20, 0x00, 0x01, 0x01, 0x00, 0xc0,
			0x01, 0x09, 0x04, 0x00, 0x00, 0x02, 0xff, 0x00,
			0x50, 0x00, 0x07, 0x05, 0x01, 0x02, 0x40, 0x00,
			0x00, 0x07, 0x05, 0x81, 0x02, 0x40, 0x00, 0x00	};

static const u8 string_lang_ids[] = {0x04, 0x03, 0x09, 0x04};

static const u8 string_manufacture[] = {	0x10, 0x03, 0x49, 0x00, 0x6e, 0x00, 0x67, 0x00,
					0x65, 0x00, 0x6e, 0x00, 0x69, 0x00, 0x63, 0x00	};

static const u8 string_product[] = {	0x2e, 0x03, 0x4a, 0x00, 0x5a, 0x00, 0x34, 0x00,
				0x37, 0x00, 0x38, 0x00, 0x42, 0x00, 0x20, 0x00,
...
#ifndef BOOTROM_TEST
static const u8 cpu_info_data[] = {	0x4a, 0x5a, 0x34, 0x37, 0x38, 0x42, 0x56, 0x31 };
					/*J Z 4 7 8 B V 1*/
#else
static const u8 cpu_info_data[] = {	0x4a, 0x5a, 0x34, 0x37, 0x38, 0x42, 0x56, 0x54 };
					/*J Z 4 7 8 B V T*/
#endif
