 ...
 *
 * JZ4780B nfi register definition.
 *
 * Copyright (C) 2012 Ingenic Semiconductor Co., Ltd.
 */
#ifndef __JZ4780NFI_H__
#define __JZ4780NFI_H__
...
#define NAND_NFCS	(NFI_BASE + 0x0c) /* nand flash chip select Register */
...
#define __pn_disable()          (REG_NAND_PNCR = 0x0)
...
#define __nfi_enable()		(REG_NAND_NFCR |= NAND_NFCR_INIT | NAND_NFCR_EN)
